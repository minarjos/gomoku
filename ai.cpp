...
eval_move Ai::play_deep_smarter_ab_selective(position &p, int d, int s, int t = 1e9, int ab = -1)
{
  ...
  sort(
      moves.begin(), moves.end(), p.to_move == 2 ? [](eval_move a, eval_move b) { return a.e < b.e; } : [](eval_move a, eval_move b) { return a.e > b.e; });
...
bool Ai::has_threes(combos &c, combos &old)
{
  ...
  return xfours != xfoursold || ofours != ofoursold || xthrees != xthreesold || othrees != othreesold;
}
